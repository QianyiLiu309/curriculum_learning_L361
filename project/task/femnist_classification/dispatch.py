...
from project.task.femnist_classification.dataset import get_dataloader_generators
from project.task.femnist_classification.train_test import get_fed_eval_fn, test, train

from project.models.cnn_femnist import get_cnn
from project.models.mlp_femnist import get_mlp
...
def dispatch_train(
    ...
    if train_structure is not None and train_structure.upper() == "FEMNIST":
...
def dispatch_data(cfg: DictConfig) -> DataStructure | None:
    ...
    # for FEMNIST and the dispatch should return None
    ...
    if client_model_and_data is not None and partition_dir is not None:
        ...
        if client_model_and_data.upper() == "FEMNIST_MLP":
            return (
                get_mlp,
                client_dataloader_gen,
                fed_dataloader_gen,
        ...
        elif client_model_and_data.upper() == "FEMNIST_CNN":
            return (
                get_cnn,
                client_dataloader_gen,
                fed_dataloader_gen,
