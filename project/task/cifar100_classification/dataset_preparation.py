...
def get_cifar_100(path_to_data):
    ...
    test_set = datasets.CIFAR100(
        ...
        train=False,
        download=True,
        transform=cifar100Transformation(),
    )
...
def do_fl_partitioning(
    ...
    """Torchvision (e.g. CIFAR-100) datasets using LDA."""
...
def download_and_preprocess(cfg: DictConfig) -> None:
    ...
    train_path, testset = get_cifar_100(path_to_data=cfg.dataset.dataset_dir)
