...
from project.task.cifar100_classification.dataset import get_dataloader_generators
from project.task.cifar10_classification.train_test import get_fed_eval_fn, test, train
from project.models.cnn_cifar100 import get_cnn
...
def dispatch_train(
    ...
    if train_structure is not None and train_structure.upper() == "CIFAR100":
...
def dispatch_data(cfg: DictConfig) -> DataStructure | None:
    ...
    # for CIFAR100 and the dispatch should return None
    ...
    if client_model_and_data is not None and partition_dir is not None:
        ...
        if client_model_and_data.upper() == "CIFAR100_CNN":
            return (
                get_cnn,
                client_dataloader_gen,
                fed_dataloader_gen,
